...
describe SMSMessage do
  ...
  describe '.booking_sent' do
    it 'creates a sms message for booking request' do
      ...
      expect(sms_message).to eq("Hi, John! Your booking for #{space} on #{date} has been received. Wait for confirmation from the landlord.")
    end
  end
  describe '.booking_confirmed' do
    it 'creates a sms message for booking comfirmation' do
      ...
      expect(sms_message).to eq("Hi, John! Your booking for #{space} on #{date} was confirmed.")
    end
  end
  describe '.booking_rejected' do
    it 'creates a sms message for booking rejection' do
      ...
      expect(sms_message).to eq("Hi, John! Your booking for #{space} on #{date} was not accepted.")
    end
  end
end
